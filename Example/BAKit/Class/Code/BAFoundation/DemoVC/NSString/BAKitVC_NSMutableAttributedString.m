//
//  BAKitVC_NSMutableAttributedString.m
//  BAKit
//
...
@interface BAKitVC_NSMutableAttributedString ()
...
@implementation BAKitVC_NSMutableAttributedString
...
- (UILabel *)label {
    if (!_label) {
        ...
        BAKit_WeakSelf;
        [_label ba_labelAddAttributeTapActionWithStrings:@[@"www.baidu.com",@"8888"] tapClicked:^(NSString *string, NSRange range, NSInteger index) {
            BAKit_StrongSelf
