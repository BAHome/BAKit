...
//  BAKit
//
//  Created by boai on 2017/6/19.
//  Copyright © 2017年 boai. All rights reserved.
//

#import "BAKitVC_BAButton.h"
#import "BAKitVC_BAButton2.h"
#import "BAKitVC_BAButton3.h"

@interface BAKitVC_BAButton ()

@property(nonatomic, strong) UIButton *button;

@end

@implementation BAKitVC_BAButton
...
- (void)setupNavi {
    ...
    UIButton *navi_leftButton = [UIButton ba_creatButtonWithFrame:frame title:@"state" selTitle:nil titleColor:BAKit_Color_Red titleFont:nil image:[UIImage imageNamed:@"tabbar_mainframeHL"] selImage:nil padding:2 buttonPositionStyle:BAKit_ButtonLayoutTypeCenterImageRight viewRectCornerType:BAKit_ViewRectCornerTypeBottomLeftAndTopLeft viewCornerRadius:20 target:self selector:@selector(handleLeftNaviButtonAction)];
    
    [navi_rightButton ba_view_setViewRectCornerType:BAKit_ViewRectCornerTypeBottomLeftAndTopLeft viewCornerRadius:20 borderWidth:2.0f borderColor:BAKit_Color_Red];
    ...
    for (NSInteger i = 0; i < 8; i ++) {
        ...
        switch (i) {
            case 0:
            {
                ...
                [button ba_button_setViewRectCornerType:BAKit_ViewRectCornerTypeBottomRightAndTopRight viewCornerRadius:viewCornerRadius borderWidth:2.0f borderColor:BAKit_Color_Red];
            }
                break;
            case 1:
            {
            ...
            case 2:
            {
                ...
                [button ba_button_setViewRectCornerType:BAKit_ViewRectCornerTypeTopLeftAndTopRight viewCornerRadius:viewCornerRadius * 2 borderWidth:2.0f borderColor:BAKit_Color_Green];
            }
                break;
            case 3:
            {
            ...
            case 4:
            {
                ...
                [button ba_button_setViewRectCornerType:BAKit_ViewRectCornerTypeBottomRight viewCornerRadius:viewCornerRadius borderWidth:2.0f borderColor:BAKit_Color_Black];
